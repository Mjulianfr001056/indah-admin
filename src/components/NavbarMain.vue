...
<template>
  <nav>
    ...
    <router-link to="/notifications" class="notification">
...
export default {
  setup () {
    ...
    onMounted(() => {
      searchButton.value = document.querySelector(
        '#content nav form .form-input button'
      )
      searchButtonIcon.value = document.querySelector(
        '#content nav form .form-input button .bx'
      )
      searchForm.value = document.querySelector('#content nav form')
      sidebar.value = document.getElementById('sidebar')

      searchButton.value.addEventListener('click', handleSearchButtonClick)
      window.addEventListener('resize', handleWindowResize)
    })

    onBeforeUnmount(() => {
      // Membersihkan event listener saat komponen dihapus
      searchButton.value.removeEventListener('click', handleSearchButtonClick)
